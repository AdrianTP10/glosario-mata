...
export default function Content({auth, errors, articles}) {
    ...
    return (
        ...
        >
            ...
            <header className=" justify-center items-center p-4 bg-gray-400 ">
                <div className="flex justify-center">
                    <div className="flex flex-row mb-3 xl:w-1/2">
                        <div className="input-group relative flex flex-wrap items-stretch w-full mb-4">
                            ...
                            <button className="btn flex px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight  uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out items-center" type="button" id="button-addon2">
